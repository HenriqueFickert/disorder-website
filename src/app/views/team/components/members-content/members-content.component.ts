...
@Component({
  ...
  templateUrl: './members-content.component.html',
  styleUrls: ['./members-content.component.scss']
})
export class MembersContentComponent {
  ...
  public members: member[] = [
    ...
    },
    {
      ...
      linkedin: "",
      github: "",
      instagram: "https://www.instagram.com/reimagnifico/",
      behance: "https://www.behance.net/reimagnifico",
      artstation: "",
      otherlink: "https://linktr.ee/reimagnifico",
